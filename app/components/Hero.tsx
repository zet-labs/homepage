...
export default async function Hero() {
  ...
  return (
    <div className="w-full flex flex-col items-center gap-6 max-md:gap-4 max-[480px]:gap-3">
      <div className="flex items-center gap-3 max-md:gap-2 animate-[fade-in-down_0.6s_ease-out]">
        <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
        <span className="text-[rgb(var(--color-foreground-muted)/0.6)] text-xs tracking-[0.15em] uppercase font-medium max-md:text-[0.7rem] max-[480px]:text-[0.65rem]">
          {t("labBadge")}
        </span>
      </div>

      <h1 className="text-[clamp(3rem,10vw,7rem)] font-medium leading-[1.1] tracking-[-0.04em] animate-[fade-in-up_0.6s_ease-out] max-md:text-[clamp(2.2rem,11vw,3.4rem)] max-[480px]:text-[clamp(2rem,12vw,2.9rem)] font-[family-name:var(--font-geist-sans)]">
