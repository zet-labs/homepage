...
const TerminalDemo = dynamic(() => import('./TerminalDemo'), {
  loading: () => {
    ...
    const shellClasses =
      'terminal-shell rounded-2xl overflow-hidden border border-[rgb(var(--color-foreground)/0.12)] bg-[rgb(var(--color-surface)/0.45)] backdrop-blur-3xl shadow-[0_20px_70px_rgb(0_0_0/0.35),inset_0_1px_0_rgb(255_255_255/0.08)] animate-pulse max-md:rounded-[22px] max-md:border-[rgb(var(--color-foreground)/0.08)] max-md:bg-[rgb(var(--color-surface)/0.72)] max-md:shadow-[0_18px_40px_rgb(0_0_0/0.22)]';
    const headerClasses =
    ...
    const bodyClasses =
      'terminal-body relative border-t border-[rgb(var(--color-foreground)/0.06)] p-5 h-[280px] max-md:p-3.5 max-md:h-[212px] max-[480px]:h-[188px] [@media(max-height:900px)]:h-[200px] [@media(max-height:800px)]:h-[180px]';
