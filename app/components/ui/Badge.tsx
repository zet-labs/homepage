...
const variantStyles: Record<BadgeVariant, string> = {
    ...
    success: 'text-[rgb(var(--color-accent-indigo)/0.85)] bg-[rgb(var(--color-accent-indigo)/0.08)] border-[rgb(var(--color-accent-indigo)/0.2)]',
...
export function Badge({ children, variant = 'default', size = 'md', className = '' }: BadgeProps) {
    const baseStyles = 'font-medium leading-[1.4] tracking-[0.15em] uppercase max-w-fit mx-auto my-0 rounded-xl border backdrop-blur-[10px] whitespace-nowrap animate-[fade-in-up_0.6s_ease-out] max-[480px]:whitespace-normal max-[480px]:max-w-[90%]';
